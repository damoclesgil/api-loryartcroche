...
export interface ApiComentarioComentario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nomeUsuario: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiOrdemOrdem extends Struct.CollectionTypeSchema {
...
export interface ApiProdutoProduto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nomeCor: Schema.Attribute.Enumeration<
      ['Rosa', 'Azul', 'Vermelho', 'Branco', 'Laranja', 'Verde']
    >;
    produtosReferentes: Schema.Attribute.Relation<
      'oneToMany',
      'api::produto.produto'
    >;
